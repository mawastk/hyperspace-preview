...
var list_texture = preload("res://image/popup/scorepreview.png")
...
func _reset():
	...
	var template = TemplateManager._get_template_list("crystal")
...
func _select(template_name : String):
	...
	if !template_name in TemplateManager._get_template_list("crystal").keys():
	...
	var template = TemplateManager._get_template_list("crystal")[selected]

...
def _mawa_bakeMeshToData(data, output_file, template_file = None, progress = None, extra_data = None):
	"""
	Warning
    
    This is a custom function that does not exist in the original Mesh Baker.
	"""
...
def _mawa_bakeMesh(input_text, output_file, template_file = None, progress = None):
	"""
	...
	return _mawa_bakeMeshToData(input_data, output_file, template_file, progress)
